...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*😈𝗔𝗧𝗧𝗔𝗖𝗞 𝗦𝗧𝗔𝗥𝗧𝗘𝗗😈\n\n👉𝗜𝗣: {target_ip}\n👉𝗣𝗢𝗥𝗧: {target_port}\n👉𝗧𝗜𝗠𝗘: {duration}\n\n👉𝗠𝗘𝗧𝗛𝗢𝗗 𝗕𝗬 @ROLEX1173*", parse_mode='Markdown')
    except Exception as e:
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/ROLEX1173/432*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Dm @ROLEX1173*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Admin @ROLEX1173*", parse_mode='Markdown')
    else:
